  ...
  return (
    <div className="flex items-center justify-center p-4">
      <div className="relative group">
        ...
        {/* Dropdown menu */}
        <div id="dropdownNavbar" className="absolute hidden right-0  group-hover:block z-10 w-56 p-3 bg-white rounded-lg shadow" >
          ...
          <div className={`overflow-hidden transition-all duration-300 ${expandedSection === "reviews" ? "max-h-[1000px]" : "max-h-0"}`}>
            <div className="flex items-center">
              ...
              <FontAwesomeIcon icon={faX} className="pl-4 text-red-600 text-l cursor-pointer" onClick={handleDelete} />
            </div>
          </div>
        </div>
      </div>
