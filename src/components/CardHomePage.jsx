function CardHomePage({ data }) {
    const { name, surname, image_url, average_vote, name_speciality } = data;
                ...
                <div className="p-4">
                    ...
                    <div className="mt-4 flex justify-between items-center">
                        ...
                        <div className="flex items-center justify-between">
                            <a href="#" className="text-teal-50 bg-teal-500 focus:ring-4 focus:outline-none focus:ring-teal-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Vedi</a>
                        </div>
                    </div>
                </div>
            </div>
