      ...
      <section className="container mt-[50px] m-auto">
        <form className="max-w-md mx-auto">
          ...
          <div className="relative">
            ...
            <button type="submit" className="text-white absolute end-2.5 bottom-2.5 bg-teal-500 hover:bg-teal-500 focus:ring-4 focus:outline-none focus:ring-teal-500 font-medium rounded-lg text-sm px-4 py-2">Search</button>
          </div>
        </form>
